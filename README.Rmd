...
I found I was rewriting the same types of analyses. How to make a modular set of tools for simulating meta-anlaysis data. 
...
NB: Caching is needed as simulations ramp in scale. The `targets` package can help.
