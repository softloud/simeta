...
These are a sometimes-useful modular set of tools for simulating meta-anlaysis data I mostly developed during my doctoral project. For more details, see the associated manuscript (freely-accessible [arxiv version](https://arxiv.org/pdf/1910.06964.pdf)).
